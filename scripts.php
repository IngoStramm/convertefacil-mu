...
wp_enqueue_script( 'cf-script', CF_URL . '/assets/js/cf-script.min.js', array( 'jquery', 'cf-jquery-mask' ), '1.0.1', true );
...
function cf_backend_scripts() {
	...
	wp_register_script( 'cf-plugin-backend-script', CF_URL . '/assets/js/cf-plugin-backend-script' . $min . '.js', array( 'jquery', 'cf-jquery-mask' ), '1.0.1z' );
