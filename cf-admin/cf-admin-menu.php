	...
	elseif( !is_super_admin( $user_id ) ) :
	    ...
	    function cf_add_menus() {
	        ...
	        add_menu_page( __( 'Operações e Logística', 'cf' ), __( 'Operações e Logística', 'cf' ), 'edit_theme_options', 'edit.php?post_type=shop_order', null, 'dashicons-search', 11 );
	        	...
	        	// Gestão de Entregas
	        	add_submenu_page( 'edit.php?post_type=shop_order', __( 'Gestão de Entregas', 'cf' ), __( 'Gestão de Entregas', 'cf' ), 'edit_theme_options', 'admin.php?page=wc-settings&tab=shipping&zone_id=1', null );	        	
