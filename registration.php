<?php
add_action( 'signup_blogform', 'cf_register_form', 1 );
...
function cf_extra_fields( $user ) {
	$utils = new Cf_Utils;
	if( !$utils->is_not_super_admin_and_is_admin_and_is_not_your_own_profile( $user ) || $utils->is_not_super_admin_and_admin() )
